<template>
  <el-card class="user-info-card" v-loading="loading">
    ...
    <el-dialog v-model="dialogVisible" title="修改密码" width="30%" :before-close="handleCancelChangePassword">
      <el-form ref="changePasswordFormRef" :model="changePasswordForm" status-icon :rules="rules" label-width="120px">
        <el-form-item label="密码" prop="pass">
          <el-input v-model="changePasswordForm.pass" type="password" autocomplete="off" />
        </el-form-item>
        <el-form-item label="确认" prop="checkPass">
          <el-input v-model="changePasswordForm.checkPass" type="password" autocomplete="off" />
        </el-form-item>
      </el-form>
      <template #footer>
