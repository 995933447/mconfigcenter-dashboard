...
const file_gateway_proto_rawDesc = "" +
	"\n" +
	"\rgateway.proto\x12\agateway\x1a\x13easymicro_ext.proto2\t\n" +
	"\agatewayB\x98\x01\x8a\x9d R\n" +
	"Jgithub.com/995933447/mconfigcenter-dashboard/backend/service/gatewayserver\x18\x01 \x01@\x01Z@github.com/995933447/mconfigcenter-dashboard/backend/api/gatewayb\x06proto3"
