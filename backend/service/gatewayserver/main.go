...
import (
	...
	"github.com/995933447/mconfigcenter-dashboard/backend/service/gatewayserver/boot"
	"github.com/995933447/mconfigcenter-dashboard/backend/service/gatewayserver/config"
	"github.com/995933447/mconfigcenter-dashboard/backend/service/gatewayserver/event"
...
func main() {
	if err := boot.InitNode("gateway"); err != nil {
	...
	if err := grpc.PrepareDiscoverGRPC(context.TODO(), gateway.EasymicroGRPCSchema, gateway.EasymicroDiscoveryName); err != nil {
		log.Fatal(runtimeutil.NewStackErr(err))
	}
