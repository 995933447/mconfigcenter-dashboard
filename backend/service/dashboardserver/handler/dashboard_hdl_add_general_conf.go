...
func (s *Dashboard) AddGeneralConf(ctx context.Context, req *dashboard.AddGeneralConfReq) (*dashboard.AddGeneralConfResp, error) {
	var resp dashboard.AddGeneralConfResp
	...
	_, err = configcenter.ConfigCenterGRPC().AddConfig(ctx, &configcenter.AddConfigReq{
